        ...
        <div class="view-product">
          <div class="company_identify">
            <div class="manage-head">
              <h6 class="padding-left manage-head-con">修改收货地址</h6>
            </div>
            <form name="setp0" action="updateaddress" method="post" autocomplete="off">
              <div class="basic-info-detail clearfix">
                <div class="unit-style padding-big-lr clearfix">
                  <h4 class="real-name-head margin-large-top">修改收货地址</h4>
                  <div class="real-name-con height-main margin-top-25">
                    <p class="content-left-zoon">
                      收货人姓名
                    </p>
                    <div class="content-right-zoon">
                      <input class="width-main input" placeholder="${address.name}" type="text" name="name" datatype="*">
                    </div>
                  </div>
                  <div class="real-name-con height-main margin-top-25">
                    <p class="content-left-zoon">
                    ...
                    <div class="content-right-zoon">
                      <input class="width-main input" placeholder="${address.address}" type="text" name="address" datatype="*">
                    </div>
                  </div>
                  <div class="real-name-con height-main margin-top-25">
                    <p class="content-left-zoon">
                    ...
                    <div class="content-right-zoon">
                      <input class="width-main input" placeholder=" ${address.tel}" type="text" name="tel" datatype="*">
                    </div>
                  </div>
                  <p>&nbsp;</p>
                </div>
              ...
              <div class="unit-style padding-large-tb clearfix">
                <div class="margin-large-top padding-left text-left content-right-zoon">
                  <input type="submit" value="修改" class="submit fl">
                </div>
              </div>
            </form>
          </div>
